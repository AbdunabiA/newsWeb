  ...
  return (
    ...
    >
      <div className="Container mt-5 flex flex-col space-y-5 text-xl">
        ...
        <div className="flex flex-col space-y-1 justify-center group [&:hover>.sub-menu]:flex cursor-pointer">
          ...
          <div className="sub-menu hidden flex-col space-y-1 text-lg w-[100%] z-10 bg-white rounded-md shadow-md p-2">
